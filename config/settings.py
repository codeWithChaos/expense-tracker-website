...
SECRET_KEY = 'django-insecure-p-7mh%qwidt_cfe_^1cyn)dmedigv$o)q$ol)uqvqs06&#t@f#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'userpreferences/templates',
            BASE_DIR / 'income/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                # Costum context processor
                'expenses.context_processor.orion_text',
            ],
        },
    },
]
